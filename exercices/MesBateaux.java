public class MesBateaux {
    ...
    public static void setNombreDeBateauxConstruits(int nombreDeBateauxConstruits) {
        MesBateaux.nombreDeBateauxConstruits = nombreDeBateauxConstruits;
    }
    ...
    public static void main(String[] args) {
        ...
        MesBateaux monBateau = new MesBateaux("OCEANS EVASION");
        ...
        // System.out.println(monBateau.getNombreDeBateauxConstruits());
